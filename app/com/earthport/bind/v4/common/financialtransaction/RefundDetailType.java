 ...
 * 			
 * 
 * <p>Java class for RefundDetailType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RefundDetailType">
 *   &lt;complexContent>
 *     &lt;extension base="{http://customer.endpoint.earthport.com/api/merchant/v4/components/financialTransactionBase}RefundType">
 *       &lt;sequence>
 ...
 *         &lt;element name="amountRefundedByBank" type="{http://customer.endpoint.earthport.com/api/merchant/v2/components/core}MonetaryValueType"/>
 ...
 *         &lt;element name="originalPayoutTransaction" type="{http://customer.endpoint.earthport.com/api/merchant/v4/components/financialTransactionBase}PayoutTransactionType"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RefundDetailType", propOrder = {
    "fxExecutedDetail",
...
public class RefundDetailType
    extends RefundType
{

    protected FXExecutedRateType fxExecutedDetail;
    @XmlElement(required = true)
    protected MonetaryValueType amountRefundedByBank;
    @XmlElement(required = true)
    protected MonetaryValueType amountRefundedToCustomer;
    protected ReasonType reason;
    @XmlElement(required = true)
    protected PayoutTransactionType originalPayoutTransaction;
    ...
    /**
     * Gets the value of the amountRefundedByBank property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public MonetaryValueType getAmountRefundedByBank() {
        return amountRefundedByBank;
    }

    /**
     * Sets the value of the amountRefundedByBank property.
     * 
     * @param value
     *     allowed object is
     *     {@link MonetaryValueType }
     *     
     */
    public void setAmountRefundedByBank(MonetaryValueType value) {
        this.amountRefundedByBank = value;
    }
    ...
    /**
     * Gets the value of the originalPayoutTransaction property.
     * 
     * @return
     *     possible object is
     *     {@link PayoutTransactionType }
     *     
     */
    public PayoutTransactionType getOriginalPayoutTransaction() {
        return originalPayoutTransaction;
    }

    /**
     * Sets the value of the originalPayoutTransaction property.
     * 
     * @param value
     *     allowed object is
     *     {@link PayoutTransactionType }
     *     
     */
    public void setOriginalPayoutTransaction(PayoutTransactionType value) {
        this.originalPayoutTransaction = value;
    }
